...
import com.dkprint.wayfarer.task.request.task.request.domain.DateType
import com.dkprint.wayfarer.task.request.task.request.domain.SearchType
...
class SearchFacade(
    ...
    fun search(searchRequest: SearchRequest): Page<TaskRequest> {
        ...
        val filteredByKeyword: List<Long>? = filteringByKeyword(searchRequest.searchType, searchRequest.keyword)
    ...
    private fun filteringByKeyword(searchType: String?, keyword: String?): List<Long>? {
